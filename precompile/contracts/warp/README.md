...
Therefore, we use the [Predicate Utils](https://github.com/mev-zone/coreth-validator/blob/master/predicate/Predicate.md) package to encode the actual byte slice of size N into the access list.
